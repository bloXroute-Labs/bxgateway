...
class AbstractGatewayBlockchainConnection(AbstractGatewayConnection):
    ...
    def msg_tx(self, msg):
        ...
        """
        blx_txmsgs = self.message_converter.tx_to_bx_txs(msg)
        ...
        for (blx_txmsg, tx_hash, tx_bytes) in blx_txmsgs:
            ...
            self.node.tx_service.hash_to_contents[tx_hash] = tx_bytes
    ...
    def msg_block(self, msg):
        ...
        bloxroute_block = self.message_converter.block_to_bx_block(msg, self.node.tx_service)

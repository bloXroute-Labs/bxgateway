...
class GatewayOpts(CommonOpts):
    ...
    def post_init_tasks(self) -> None:
        ...
        if self.blockchain_network is None or self.blockchain_protocol is None:
            logger.fatal("Blockchain network and protocol information is missing exiting.")
            sys.exit(1)

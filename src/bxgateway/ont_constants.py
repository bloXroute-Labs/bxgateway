...
STARTUP_SYNC_PORT = 20338
STARTUP_HTTP_INFO_PORT = 20333
STARTUP_CONS_PORT = 9999
STARTUP_CAP = bytes(32)
STARTUP_RELAY_STATE = True
STARTUP_IS_CONSENSUS = True
STARTUP_SOFT_VERSION = "bloxroute_ontology"
...
ONT_CONS_HEIGHT_BKINDEX_TIME_LEN = 10
ONT_CONS_OWNER_LEN = 33
ONT_DATA_MSG_LEN = 65
...
ONT_VARINT_SHORT_INDICATOR = 0xFD
ONT_VARINT_INT_INDICATOR = 0xFE
ONT_VARINT_LONG_INDICATOR = 0xFF

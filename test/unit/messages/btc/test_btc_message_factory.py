...
class BtcMessageFactoryTest(MessageFactoryTestCase):
    ...
    def test_segwit_tx_hash(self):
        ...
        self.assertTrue(btc_messages_util.is_segwit(seg_tx_bytes))
        self.assertEqual(convert.bytes_to_hex(btc_messages_util.get_txid(seg_tx_bytes).binary),
    ...
    def test_non_segwit_tx_hash(self):
        ...
        self.assertFalse(btc_messages_util.is_segwit(non_seg_tx_bytes))
        self.assertEqual(convert.bytes_to_hex(btc_messages_util.get_txid(non_seg_tx_bytes).binary),

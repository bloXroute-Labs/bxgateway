...
class BtcRelayConnectionTest(AbstractTestCase):
    ...
    def test_msg_broadcast_wait_for_key(self):
        ...
        broadcast_message = BroadcastMessage(ObjectHash(block_hash), self.TEST_NETWORK_NUM, True, ciphertext)
    ...
    def test_msg_broadcast_duplicate_block_with_different_short_id(self):
        ...
        unknown_message = BroadcastMessage(ObjectHash(unknown_block_hash), self.TEST_NETWORK_NUM, True, unknown_cipher)
        ...
        known_message = BroadcastMessage(ObjectHash(known_block_hash), self.TEST_NETWORK_NUM, True, known_cipher)
    ...
    def test_get_txs_block_recovery(self):
        ...
        broadcast_message = BroadcastMessage(ObjectHash(block_hash), DEFAULT_NETWORK_NUM, True, ciphertext)
